...
pub fn pretty_recurse_no_dots(query: String, path: String) -> recursive_file_search::Pretty{
             ...
             if dir.file_name().to_str().unwrap().starts_with(".") == false { 
              if place.is_dir() {
               ...
               if place.is_file() { 
                  ...
                  let new_name = String::from(&query);
                  let res2 = pretty_recurse_no_dots(new_name,string_path );
