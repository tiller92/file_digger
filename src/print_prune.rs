// ignore the directory thats give 
...
pub fn print_prune(name: String, path:String, depth:u32) -> Pretty{
  ...
  for item in directory{ 
      ...
      match meta {
          Ok(place) => {
            ...
            let dir_to_skip: path::PathBuf = path::PathBuf::from(&name);
            ...
            let mut dash_file = String::from("  ");
              ...
              if place.is_dir() && curr_location != dir_to_skip{
               ...
               if place.is_file() { 
                  ...
                  let res2 = print_prune(new_name,string_path, depth+1);
