// this should not print hidden files/
// this shoud be the default call unless -a flag is added
...
pub fn print_full_path(name: String, path:String, depth:u32) -> Pretty{
      ...
      match meta {
          Ok(place) => {
            ...
            // now print each folder and file
                  ...
                  println!("{}|-{}",dash_string, dir.path().to_str().unwrap());
               ...
               if place.is_file() { 
                  ...
                  let res2 = print_full_path(new_name,string_path, depth+1);
